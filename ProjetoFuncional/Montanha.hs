module Montanha where 
 ...
 montanha = Local{  
           nomeLocal = "Montanha" 
         , inventarioLocal = listaParaInventario [comida, carvão] 
         , eventosInvestigacao =  
             [ 
                 EventoInvestigacao  
                 { -- Paredão com ovos de pássaro 
                     requisitosInvestigacao = [água] 
                 ...
                 { -- a mensagem do deus das frutas tropicais 
                     requisitosInvestigacao = [água, lanterna] 
                     , alvoInvestigacao = [carvão] 
         ...
         , eventosColeta =  
             [ 
                 EventoColeta  
                 { 
                       requisitosColeta = [água, bolsa] 
                     , coletado = comida
 
                 }, 
                 EventoColeta  
                 { 
                       requisitosColeta = [mochila, picareta, água]
                     , coletado = carvão
