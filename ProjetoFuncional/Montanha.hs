 ...
 montanha = Local{  
           ...
           , eventosInvestigacao = 
               [
                   ...
                   EventoInvestigacao 
                   { -- Evento de 1/2 Sucesso
                       requisitosInvestigacao = [picareta]
                       ,alvoInvestigacao = [bussola]
                       , mensagemFalha = " Boa sorte quebrando rocha solida com a mao. Aqui não eh Minecraft."
                   ...
                   { -- Evento de 1/2 Sucesso
                       ...
                       , mensagemFalha = "Boa sorte escalando uma montanha sem uma corda. Aqui nao eh Celeste."
